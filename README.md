...
value or parameter. Effects from parallel downloads through that client are
capped at `k`. The checker trusts the client configuration; for OkHttp, set
the matching `Dispatcher.maxRequests` value.
