...
/** Creates the Kotlin 2.2 function-checker set backed by [inference]. */
...
/** Returns the current Kotlin 2.2 source path or a stable fallback label. */
 ...
 *
 * Kotlin 2.2 exposes no corresponding FIR wrapper, so this adapter always
 * returns `null`.
 */
internal fun FirElement.functionTypeConversionOperand(): FirExpression? = null

/** Returns the elements of a Kotlin 2.2 FIR array literal, if this is one. */
